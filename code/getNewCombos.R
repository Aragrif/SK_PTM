...
#' combination strategies based on the expert estimates for the ALL Strategies combination (with both S5 + S6 -- this was labelled as S22 in
#' the original tables)
#'   
#' Requires **Estimates_aggregated_benefits.csv** and **Estimates_aggregated_baseline.csv** from *aggregateEstimates.R*, and a
